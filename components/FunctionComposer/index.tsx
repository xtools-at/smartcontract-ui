...
export const FunctionComposer = ({
	...
	const [signerAnchorEl, setSignerAnchorEl] = useState<null | HTMLElement>(
		null
	);
			...
			<Grid container spacing={1}>
							...
							<TextField
								...
								helperText={
									history.length > 0 && (
										<>
											Or browse from{" "}
											<Link sx={{ cursor: "pointer" }} onClick={openHistory}>
												your history
											</Link>
											.
										</>
				...
				>
					...
					<Dialog
						...
						open={importWalletIsOpen}
						onClose={closeWalletImport}
					>
						<DialogTitle>Import Wallet</DialogTitle>
						<DialogContent>
							<DialogContentText>
								You can import the wallet from a private key, or from mnemonic
								words.
								<br />
								<br />
								<Alert severity="info">
									Your data <b>WILL NOT BE</b> saved anywhere
								</Alert>
								<br />
							</DialogContentText>
							<QrTextField
						...
						>
							...
							<Button variant="contained" onClick={importWallet}>
								Import
							</Button>
						</DialogActions>
					</Dialog>
							...
							{(() => {
								...
								if (input.type.endsWith("[]")) {
									return (
										<Tooltip
											arrow
											title="Multiple values, you can separate each value by new line"
										>
											<TextField multiline margin="normal" {...props} />
										</Tooltip>
									);
								} else if (
										...
										<Tooltip
											...
											title={
												<>
													Numeric value
													<br />
													You can use the exponential box, example: 5 x 10^3 =
													5000
												</>
											}
										>
									...
									return (
										<Tooltip arrow title="An Ethereum address (0x....)">
											<QrTextField margin="normal" {...props} />
										</Tooltip>
									);
